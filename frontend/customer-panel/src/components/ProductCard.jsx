...
const ProductCard = ({ item, setSearchText }) => {
    ...
    return (
        <div className="border border-gray-200 rounded-lg p-4 overflow-hidden hover:border-black duration-200 cursor-pointer">
            <div className="w-full h-60 relative p-2 group">
                <span
                    onClick={open}
                    className="bg-red-500 text-white absolute left-0 right-0 w-16 text-xs text-center py-1 rounded-md font-semibold inline-block z-10"
                >
                            ...
                            >
                                <DialogPanel className="w-full max-w-md rounded-xl bg-black backdrop-blur-2xl z-50 p-6">
                                    ...
                                    <p className="text-sm/6 text-white/50">
                                        ...
                                        adipisicing elit. Sequi, consequatur?
                                    </p>
                                    <div className="mt-4">
                                        <Button
