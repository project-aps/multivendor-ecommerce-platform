    ...
    return (
        <Container>
            ...
            {favoriteProduct?.length > 0 ? (
                <div>
                    <div className="border-b mt-3 border-b-gray-300 pb-6">
                        <h2 className="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">
                            Favorite Products
                        </h2>
                        {/* <p className="mt-2 text-sm text-gray-500 max-w-[500px] tracking-wide">
                            Lorem ipsum dolor, sit amet consectetur adipisicing
                            elit. Soluta ut commodi ipsam provident numquam,
                            odit cupiditate, incidunt cum pariatur excepturi
                            dicta laboriosam error quo dolore libero. Maxime ad
                            laborum libero?
                        </p> */}
                    </div>
                ...
                <div className="mx-auto flex max-w-3xl flex-col gap-3 items-center text-center">
                    ...
                    {/* <p className="text-lg tracking-wide leading-6 text-gray-500">
                        Lorem ipsum dolor, sit amet consectetur adipisicing
                        elit. Quidem harum ducimus, quod amet pariatur omnis ex
                        dolorem, distinctio molestiae aspernatur iste aperiam
                        nostrum tempore accusamus modi quos culpa corrupti ea.
                    </p> */}
                    <Link
                        to={"/product"}
