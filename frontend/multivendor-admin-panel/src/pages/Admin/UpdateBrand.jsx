...
const UpdateBrand = () => {
    ...
    useEffect(() => {
        const fetchProduct = async () => {
            try {
                const response = await vendorProductsAxios.get(`/brands/${id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await vendorProductsAxios.put(`/brands/${id}`, formData, {
                headers: {
    ...
    return (
        <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg mt-10">
            <h2 className="text-2xl font-semibold mb-6">Update Brand</h2>
